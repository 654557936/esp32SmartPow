...
static void lv_pc_state_update(lv_obj_t* pc_state_scr)
{
    ...
    line = "CPU Usage:55.1%;RAM Usage:66.3%;CPU Temp: 55c;CPU Frequency: 3.5GHz;RAM Used: 2GB;RAM Aval: 8GB;GPU Used: 2GB;GPU Frequency: 1.2GHz;FPS: 60Hz;UPLOAD 5.2MB/s;DOWNLOAD 12.5MB/s";
    Serial.println(line);
    ...
    dataEnd = line.indexOf("%;", dataStart);
    dataStr = line.substring(dataStart, dataEnd);
    String ramUsgStr = dataStr;
    lv_arc_set_value(ram_usage_arc,ramUsgStr.toInt());
